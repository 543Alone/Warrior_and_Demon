...
armors_list = [
    ...
    {"name": "👙 黄金比基尼", "def": 80, "dodge": 0.0, "desc": "众所周知，布料越少防御越高 (仅限女性角色有效?)","effect": "charm"},
    {"name": "🐢 龟壳背包", "def": 40, "dodge": -0.20, "desc": "防御力惊人，但重得让你想趴在地上走", "effect": None},
    {"name": "🔮 虚空法袍", "def": 10, "dodge": 0.15, "desc": "看似布料，实则由魔法力场编织，能让身体变得虚幻。", "effect": "magic_dodge"},
    {"name": "💎 水晶护甲", "def": 55, "dodge": -0.10, "desc": "由地下发光水晶打磨而成，因为是透明的，所以里面还是要穿衣服的。", "effect": "reflect_light"},
    {"name": "🧛 鲜血披风", "def": 15, "dodge": 0.05, "desc": "散发着腥甜气息的披风，似乎能渴望敌人的生命。", "effect": "life_steal_passive"},
]
