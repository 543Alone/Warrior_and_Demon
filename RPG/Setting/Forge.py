...
# 武器词条池 (名称, 权重)
WEAPON_AFFIX_POOL = [
    {"type": "crit_rate", "name": "致命", "desc": "暴击率提升", "value_range": [0.05, 0.15], "format": "+{:.0f}% 暴击率"},
    {"type": "crit_dmg", "name": "残暴", "desc": "暴击伤害提升", "value_range": [0.2, 0.5], "format": "+{:.0f}% 暴击伤害"},
    {"type": "lifesteal", "name": "吸血", "desc": "造成伤害时回血", "value_range": [0.05, 0.20], "format": "+{:.0f}% 吸血"},
    {"type": "atk_percent", "name": "锋锐", "desc": "基础攻击力百分比加成", "value_range": [0.1, 0.3], "format": "+{:.0f}% 攻击力"}
]

# 防具词条池
ARMOR_AFFIX_POOL = [
    {"type": "dodge", "name": "灵动", "desc": "闪避率提升", "value_range": [0.05, 0.15], "format": "+{:.0f}% 闪避率"},
    {"type": "max_hp_percent", "name": "强健", "desc": "最大生命值提升", "value_range": [0.1, 0.3], "format": "+{:.0f}% 生命上限"},
    {"type": "def_percent", "name": "坚固", "desc": "基础防御百分比加成", "value_range": [0.1, 0.4], "format": "+{:.0f}% 防御力"},
    {"type": "hp_regen", "name": "复苏", "desc": "每次受击回复少量生命值", "value_range": [1, 5], "format": "受击回血 +{:.0f}"}
]
